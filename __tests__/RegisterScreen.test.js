...
describe('<RegisterScreen />', () => {
  ...
  test('registers successfully with correct credentials', async () => {
    ...
    const instance = component.root.findByType(RegisterScreen).instance;
    await instance.handleRegisterPress();
    expect(navigate).toHaveBeenCalledWith('Login');
  });
  ...
  //   });
  //   await instance.handleRegisterPress();
  //   expect(instance.state.error).toEqual('Passwords do not match.');
  // });
